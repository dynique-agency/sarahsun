...
const translations = {
  de: {
    ...
    // About Sarah Section
    'about.badge': 'Die Gründerin',
    'about.title': 'Sarah Maron',
    'about.subtitle': 'Expertin für perfekte Bräune',
    'about.desc': 'Seit über 10 Jahren verwandle ich Menschen in strahlende, selbstbewusste Versionen ihrer selbst. Jeder Besuch ist mehr als nur Bräunen – es ist eine Auszeit vom Alltag und ein Moment der Selbstfürsorge.',
    'about.stat1': 'Jahre',
    'about.stat2': 'Kunden',
    'about.stat3': '⭐ Sterne',
    'about.quote': '"Jeder verdient es, sich wohlzufühlen und selbstbewusst zu strahlen."',
  ...
  nl: {
    ...
    // About Sarah Section
    'about.badge': 'De Oprichtster',
    'about.title': 'Sarah Maron',
    'about.subtitle': 'Expert in perfecte bruining',
    'about.desc': 'Al meer dan 10 jaar transformeer ik mensen tot stralende, zelfverzekerde versies van zichzelf. Elke bezoek is meer dan alleen bruinen – het is een pauze van de dagelijkse routine en een moment van zelfzorg.',
    'about.stat1': 'Jaar',
    'about.stat2': 'Klanten',
    'about.stat3': '⭐ Sterren',
    'about.quote': '"Iedereen verdient het om zich goed te voelen en zelfverzekerd te stralen."',
  ...
  fr: {
    ...
    // About Sarah Section
    'about.badge': 'La Fondatrice',
    'about.title': 'Sarah Maron',
    'about.subtitle': 'Experte en bronzage parfait',
    'about.desc': 'Depuis plus de 10 ans, je transforme les gens en versions rayonnantes et confiantes d\'eux-mêmes. Chaque visite est plus qu\'un simple bronzage – c\'est une pause de la routine quotidienne et un moment de soins personnels.',
    'about.stat1': 'Années',
    'about.stat2': 'Clients',
    'about.stat3': '⭐ Étoiles',
    'about.quote': '"Chacun mérite de se sentir bien et de rayonner avec confiance."',
  ...
  en: {
    ...
    // About Sarah Section
    'about.badge': 'The Founder',
    'about.title': 'Sarah Maron',
    'about.subtitle': 'Expert in perfect tanning',
    'about.desc': 'For over 10 years, I have been transforming people into radiant, confident versions of themselves. Every visit is more than just tanning – it\'s a break from daily routine and a moment of self-care.',
    'about.stat1': 'Years',
    'about.stat2': 'Customers',
    'about.stat3': '⭐ Stars',
    'about.quote': '"Everyone deserves to feel good and radiate with confidence."',
